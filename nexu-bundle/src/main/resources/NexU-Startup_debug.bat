...
start .\java\bin\javaw -verbose --module-path .\javafx-sdk-11\lib --add-modules=javafx.controls --add-modules=javafx.swing -Djavafx.preloader=lu.nowina.nexu.NexUPreLoader -Dglass.accessible.force=false -Xdebug -Xrunjdwp:transport=dt_socket,address=8989,server=y,suspend=n -jar nexu.jar